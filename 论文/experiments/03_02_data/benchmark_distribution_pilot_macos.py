#!/usr/bin/env python3
"""macOS pilot for direct NetCDF versus an outer tar.gz package.
...
def main() -> None:
    ...
    raw_path = ROOT / "pilot_macos_raw.csv"
    ...
    write_csv(ROOT / "pilot_macos_summary.csv", summaries)
    run_metadata = {
        ...
        "cache_condition": (
            ...
            "no privileged macOS cache eviction was performed"
        ),
    ...
    with (ROOT / "pilot_macos_metadata.json").open("w", encoding="utf-8") as stream:
